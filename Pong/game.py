...
class Pong:
    ...
    def playGame(self):
        ...
        self.player = Paddle((255, 255, 255), 25, int(self.height/2 - self.player.height/2), 15, self.height * 0.25, self.playerScore, self.screen)
        self.enemy = Paddle((255, 255, 255), self.width - 30, int(self.height /2 - self.player.height/2), 15, self.height * 0.25, self.enemyScore,self.screen)
